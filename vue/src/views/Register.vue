<template>
  <div class="login-container">
    <div style="display: flex; width: 50%; justify-content: center">
      <div class="login-box">
        <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #3f4585">欢 迎 注 册</div>
        <el-form ref="formRef" :model="data.form" :rules="data.rules">
          ...
          <el-form-item>
            <el-button size="large" type="primary" style="background-color: #3f4585; border-color: #3f4585; width: 100%" @click="login">注 册</el-button>
          </el-form-item>
          <div style="text-align: right">
            已有账号？请 <a style="color: #3f4585" href="/login">登录</a>
          </div>
        </el-form>
      </div>
    </div>
