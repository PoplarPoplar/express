<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template v-slot="scope">
            <el-button type="primary" plain @click="handleEdit(scope.row)" v-if="scope.row.status === '待审核'">审批</el-button>
    ...
    <el-dialog title="申请信息" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        ...
        <el-form-item prop="feedback" label="审批反馈">
          <el-input type="textarea" :rows="3" v-model="data.form.feedback" placeholder="请输入审批反馈"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
