  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="cover" label="资讯封面">
          <template #default="scope">
            <el-image style="width: 100px; height: 60px; border-radius: 5px" :src="scope.row.cover" :preview-src-list="[scope.row.cover]" preview-teleported></el-image>
          </template>
        </el-table-column>
    ...
    <el-dialog title="资讯信息" v-model="data.formVisible" width="50%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        <el-form-item label="资讯标题" prop="title">
          <el-input v-model="data.form.title" placeholder="资讯标题"></el-input>
        </el-form-item>
